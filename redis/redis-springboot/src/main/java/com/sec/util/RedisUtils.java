...
public final class RedisUtils {
     ...
     * @param key 键 * @param item 项 * @param value 值 * @return true 成功 false失败 */
    ...
    /*** 向一张hash表中放入数据,如果不存在将创建 ** @param key 键 * @param item 项 * @param value 值 * @param time 时间(秒)
    ...
    /*** 删除hash表中的值 ** @param key 键 不能为null
...
// /*** 根据key获取Set中的所有值 * @param key 键 */
    ...
    /***
     * 通过索引 获取list中的值 ** @param key 键 * @param index 索引 index>=0时，
     * 0 表头，1 第二个元素，依次类推；index<0 时，-1，表尾，-2倒数第二个元素，依次类推
     * */
